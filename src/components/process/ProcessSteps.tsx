  ...
  return (
    <section className="w-full flex justify-center px-4 md:px-0 mt-20">
      ...
      <div className="flex flex-col w-full max-w-[1596px] border-l border-r border-t border-b border-neutral-700 bg-neutral-800">
        ...
        {/* ---------------- Header Section ---------------- */}
        <div className="flex flex-col gap-[50px] px-4 py-10 md:px-[50px] lg:pt-[80px] lg:pb-[80px] border-b border-neutral-700">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 w-full">
            {processSteps.map((step, index) => (
                <div 
                    key={index}
                    className={`
                        flex flex-col p-8 md:p-[50px] gap-[50px]
                        border-neutral-700
                        ${/* إضافة Border Bottom لكل العناصر ما عدا آخر صف (في حالة الديسكتوب) أو آخر عنصر */ ""}
                        border-b
                ...
                >
                    {/* Header: Number + Title */}
                    <div className="flex items-end gap-[14px] w-full pb-[26px] border-b border-neutral-700">
                        {/* Number */}
                        <span className="text-brand-400 font-barlow text-[80px] md:text-[150px] font-semibold leading-none">
                            {step.number}
                        </span>
                        
                        {/* Title (Aligned to bottom) */}
                        <div className="pb-4 md:pb-8">
                            <h3 className="text-neutral-200 font-barlow text-2xl md:text-[26px] font-medium">
                                {step.title}
                            </h3>
                        </div>
                    </div>
